package com.neosoft.kafka.producer;

import com.neosoft.kafka.config.KafkaConfig;
import com.neosoft.kafka.config.TwitterConfig;
...
//    }
	...
	public Client createTwitterClient(BlockingQueue<String> msgQueue) {
		...
		/** Creating a client */
		ClientBuilder builder = new ClientBuilder().name("Hosebird-Client").hosts(hosebirdHosts)
				.authentication(hosebirdAuth).endpoint(hbEndpoint).processor(new StringDelimitedProcessor(msgQueue));
