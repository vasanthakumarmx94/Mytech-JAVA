...
class Customer implements SavingsAccount {
	...
	public void deposit(double amount, Date date) {
		balance += amount;
		addTransaction(String.format(NumberFormat.getCurrencyInstance().format(amount) + " credited to your account. Balance - "
		...
		outer: while (true) {
			...
			case 1:
				...
				while (bank.customerMap.containsKey(username)) {
					System.err.println("Username already exists. Set again : ");
					username = sc.next();
				}
				System.out.println(
				...
				while (!sc.hasNextDouble()) {
					System.err.println("Invalid amount. Enter again :");
					sc.nextLine();
				}
					...
					if (customer.password.equals(password)) {
						...
						while (true) {
							...
							case 2:
								...
								sc.nextLine();
								if (amount > 300000) {
									System.err.println("Transfer limit exceeded. Contact bank manager.");
									break;
								}
								if (bank.customerMap.containsKey(username)) {
